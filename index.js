...
function addGamesToPage(games) {
    ...
    for(let i = 0;i<games.length;i++){
        ...
        const display = `<h1>this is the ${i+1} game in the collection!</h1> 
...
const unfundedGamesString = `
  Sea Monster has raised $${totalPledged.toLocaleString()} for ${totalGames} games.
  ${totalUnfundedGames > 0
    ? `However, ${totalUnfundedGames} game${totalUnfundedGames > 1 ? 's' : ''} ${
        totalUnfundedGames === 1 ? 'remains' : 'remain'
      } unfunded.`
